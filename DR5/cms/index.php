...
<html lang="en">
 ...
 <?php include_once('includes/header.php');?>
      <div class="ftco-blocks-cover-1" id="home">
        ...
        <!-- END .ftco-cover-1 -->
        <div class="ftco-service-image-1 pb-5 text-center">
    <div class="container">
...
<div class="site-section" id="branch-section">
        <div class="container">
          ...
          <div class="owl-carousel owl-all">
           ...
           <?php
$query=mysqli_query($con,"SELECT * FROM tblbranch WHERE bool = 1");
while ($row=mysqli_fetch_array($query)){
?>
...
<div class="row" data-aos="fade-up" data-aos-delay="200">
 ...
 <div class="col-lg-3 order-lg-2">
    <div class="bg-white p-1 p-md-5">
      <h3 class="text-black mb-4">Contact Form</h3>
...
<div class="col-lg-5 order-lg-3">
  <div class="bg-white p-3 p-md-5" style="height: 450px">
  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1006174.9578282327!2d123.50252624201356!3d9.903032192771514!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x33aa17de1ba154df%3A0x6bc8bf042118d020!2sBohol!5e0!3m2!1sen!2sph!4v1683722439365!5m2!1sen!2sph" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
  </div>
</div>
</div>
